// Define subscript operators for your StrVec, String, StrBlob, and StrBlobPtr
// classes.
// ... I'll just do String
...
public:
  ...
  char &operator[](const size_t i) { return chars[i]; }
  const char &operator[](const size_t i) const { return chars[i]; }
